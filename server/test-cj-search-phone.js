...
async function testCJSearchPhone() {
  console.log('🔍 Test de recherche CJ pour "phone" avec paramètres optimisés...\n');
  ...
  try {
    ...
    // 2. Test de recherche avec paramètres optimisés
    console.log('\n🔍 Test de recherche "phone" avec paramètres optimisés...');
    const searchResponse = await axios.get('https://developers.cjdropshipping.com/api2.0/v1/product/list', {
      ...
      params: {
        pageNum: 1,
        pageSize: 50, // Augmenter le nombre de produits
        keyword: 'phone',
        countryCode: 'US',
        sortBy: 'relevance',
        searchType: 0, // All products
        // Pas de filtres de prix pour avoir plus de résultats
      },
      timeout: 30000
    });
